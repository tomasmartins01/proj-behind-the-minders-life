const getShortCode = country => {
  switch (country) {
    ...
    case "Comoros":
      return "KM";
    case "Congo, Republic of the (Brazzaville)":
      return "CG";
    case "Congo, the Democratic Republic of the (Kinshasa)":
      return "CD";
    case "Cook Islands":
      return "CK";
    case "Costa Rica":
      return "CR";
    case "Côte d'Ivoire, Republic of":
      return "CI";
    case "Croatia":
      return "HR";
    case "Cuba":
    ...
    case "United Kingdom":
      return "GB";
    case "United States Minor Outlying Island":
      return "UM";
    case "United States":
      return "US";
    case "Uruguay":
